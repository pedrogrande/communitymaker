...
class EnquiriesControllerTest < ActionController::TestCase
  ...
  test "should create enquiry" do
    assert_difference('Enquiry.count') do
      post :create, enquiry: { email: @enquiry.email, enquiry_type: @enquiry.enquiry_type, message: @enquiry.message, name: @enquiry.name }
    end
  ...
  test "should update enquiry" do
    patch :update, id: @enquiry, enquiry: { email: @enquiry.email, enquiry_type: @enquiry.enquiry_type, message: @enquiry.message, name: @enquiry.name }
    assert_redirected_to enquiry_path(assigns(:enquiry))
  end
